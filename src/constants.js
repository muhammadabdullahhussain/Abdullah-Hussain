...
import myTodoApp from "./assets/projects/mytodoapp.png";
...
export const projects = [
  ...
  },
  {
    ...
    github:
      "https://github.com/muhammadabdullahhussain/09ReactRouterProjectAndLearning", // Replace with your actual repo URL if different
  ...
  },
  {
    ...
    github:
      "https://github.com/muhammadabdullahhussain/employee-management-system",
  ...
  {
  id: 12,
  title: "MyTodoApp – React Todo Manager",
  description:
    "A sleek and modern Todo App built using React JS, Context API, and Tailwind CSS. It allows users to add, update, delete, and mark todos as complete. The app uses React Context for state management and has a clean, responsive UI with reusable components.",
  image: myTodoApp, // Replace with actual image import, e.g., import myTodoAppImage from './assets/todoapp.png'
  tags: ["React JS", "Tailwind CSS", "Context API", "JavaScript", "Responsive UI"],
  github: "https://github.com/muhammadabdullahhussain/13-Todo-App-with-context-api-chai-aur-react",
  webapp: "https://mytodoaap.netlify.app/"
}
